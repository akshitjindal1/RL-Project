...
def btn_click_generate_summary_with_feedback(dataset,video_name,normal_summary_path):
    ...
    positive_feed = "00:45 00:53\n01:47 01:58"
    negative_feed = "04:50 05:30"
    ...
    plot_normal_and_custom_summary(normal_summary_path, customized_summary_path,dataset,video_name)
...
if __name__ == "__main__":
    dataset_name = "UTE"
    video_name = "P03"
    normal_summary_path = "output_summary_without_feedback/P03_UTE_policy_grad_summary_length_600_subshot_size_200_hidden_dim_256_summary_without_feedback.txt"
    btn_click_generate_summary_with_feedback(dataset_name, video_name, normal_summary_path)
